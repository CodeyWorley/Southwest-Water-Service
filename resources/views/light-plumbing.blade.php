                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="product-image">
                            <img id="product-image" src="media/sink.png" class="img-responsive" title="Reverse Osmosis System">
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        <div class="product-name">
                            <h2 style="color:#377def;">We Can Do It All</h2>
                        </div>
                        <hr>
                        <div class="product-info">
                            <p id="pText">
                                From garbage disposals to toilet installs, we can literally do it all! Contact us for a free quote now.
                            </p>
