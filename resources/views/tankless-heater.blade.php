...
<html lang="en">
    <head>
      <title>Tankless Heaters | Southwest Water Service</title>
      <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="product-image">
                            <img id="product-image" src="media/tankless-heater.png" class="img-responsive" title="Reverse Osmosis System">
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        ...
                        <div class="product-info">
                            <p id="pText">
                                The Health Point Tankless Water Heater comes with an environmentally friendly burner and efficient electrical system too keep costs low while staying eco friendly.
                            </p>
