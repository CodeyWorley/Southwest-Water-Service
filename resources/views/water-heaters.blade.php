                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="product-image">
                            <img id="product-image" src="media/water-heater.png" class="img-responsive" title="Reverse Osmosis System">
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        <div class="product-name">
                            <h2 style="color:#377def;">Health Point Heating</h2>
                        </div>
                        <hr>
                        <div class="product-info">
                            <p id="pText">
                                The Health Point Water Heater comes with an environmentally friendly Low-NOx burner that provides ample hot water for households. The electronic ignition system eliminates the standing pilot light, saves energy and monitors system performance. Its maintenance free combustion air intake system means there are no filters to clean and replace. A patented magnesium anode rod design incorporates a special resistor that protects the tanks from rust, providing longer tank life. Factory installed temperature and pressure relief valve and 3/4 in. water connections. Our water heaters are ENERGY STAR qualified!
                            </p>
