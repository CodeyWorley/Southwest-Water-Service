...
<html lang="en">
    <head>
      <title>Leak Protection | South West Water Service</title>
      <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="product-image">
                            <img id="product-image" src="media/tray.png" class="img-responsive" title="Leak Guard">
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        <div class="product-name">
                            <h2 style="color:#377def;">Leak Guard</h2>
                        </div>
                        <hr>
                        <div class="product-info">
                            <p id="pText">
                                Have you ever had to deal with a leaky sink ruining your cabinetry? Don't let a small undetected leak cost you, ask us about our leak guard protection! All trays are custom made to fit your cabinets perfectly to ensure full protection. We also offer optional leak detector alarms that will notify you within minutes of a leak. Call for pricing!
                            </p>
