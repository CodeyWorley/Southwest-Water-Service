                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="product-image">
                            <img id="product-image" src="media/carbon-brine.png" class="img-responsive" title="Reverse Osmosis System">
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        <div class="product-name">
                            <h2 style="color:#377def;">Health Point Softening</h2>
                        </div>
                        <hr>
                        <div class="product-info">
                            <p id="pText">
                                If you’re looking to add more life to your water-using appliances and save money on soap and detergent in the process, it's definitely time to install a water softener. Water softeners soften the water by removing minerals such as calcium and magnesium and replacing them with a softer mineral – sodium or potassium. Soft water can also make your hair and skin look and feel healthier. Keep your home safe with one of our Health Point Systems.
                            </p>
