    ...
    <body>
        ...
        <section>
            <div class="products-header text-center">
                <h1 style="color:#377def">Find A Product</h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="panel">
                            <div class="panel-body"><a href="/reverse-osmosis" title=""><img src="media/ro.png" class="img-responsive" alt="Reverse Osmosis Systems"></a></div>
                            <div class="panel-footer text-center">Reverse Osmosis</div>
                        </div>
                    </div>

                    <div class="col-sm-4">
                        <div class="panel">
                            <div class="panel-body"><a href="/water-softeners" title=""><img src="media/carbon-brine.png" class="img-responsive" alt="Water Softeners"></a></div>
                            <div class="panel-footer text-center">Water Softeners</div>
                        </div>
                    </div>

                    <div class="col-sm-4">
                        <div class="panel">
                            <div class="panel-body"><a href="/water-heaters" title=""><img src="media/water-heater.png" class="img-responsive" alt="Water Heaters"></a></div>
                            <div class="panel-footer text-center">Water Heaters</div>
                        </div>
                    </div>

                    <div class="col-sm-4">
                        <div class="panel">
                            <div class="panel-body"><a href="/whole-house-carbon" title=""><img src="media/carbon.png" class="img-responsive" alt="Whole House Carbon"></a></div>
                            <div class="panel-footer text-center">Whole House Carbon</div>
                        </div>
                    </div>
