                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="product-image">
                            <img id="product-image" src="media/salt.png" class="img-responsive" title="Reverse Osmosis System">
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        <div class="product-name">
                            <h2 style="color:#377def;">Softener/Carbon Maintenance</h2>
                        </div>
                        <hr>
                        <div class="product-info">
                            <p id="pText">
                                Never lift a heavy salt bag again! With our salt and potassium contracts, we will take care of all the work maintaining and servicing your Softener/Carbon systems. Our plans are tailored to each individual customers needs to make the service as cost effective and easy as possible.
                            </p>
