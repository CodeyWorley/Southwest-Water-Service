                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="product-image">
                            <img id="product-image" src="media/carbon.png" class="img-responsive" title="Reverse Osmosis System">
                        </div>
                    </div>
                    <div class="col-sm-7 col-md-7 col-lg-6">
                        <div class="product-name">
                            <h2 style="color:#377def;">Health Point Purification</h2>
                        </div>
                        <hr>
                        <div class="product-info">
                            <p id="pText">
                                Our high quality Whole House Carbon Filters can treat your home’s water problems – those you see and those you don’t. Granular Activated Carbon (GAC) is used to adsorb and remove contaminants from your water, leaving the water odorless, colorless and free of any taste. The Health Point Whole House Carbon is great for keeping your home's water safe and refreshing.
                            </p>
